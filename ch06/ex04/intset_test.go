...
func TestIntSet_Elems(t *testing.T) {
	tests := []struct {
		...
		{IntSet{[]uint64{0}}, []int{}},
		{IntSet{[]uint64{1}}, []int{0}},
		{IntSet{[]uint64{2}}, []int{1}},
		{IntSet{[]uint64{3}}, []int{0, 1}},
		{IntSet{[]uint64{21}}, []int{0, 2, 4}},
		{IntSet{[]uint64{63}}, []int{0, 1, 2, 3, 4, 5}},
	}
...
func TestIntSet_IntersectWith(t *testing.T) {
	tests := []struct {
		...
		{IntSet{[]uint64{0}}, IntSet{[]uint64{0}}, IntSet{[]uint64{0}}},
		{IntSet{[]uint64{0}}, IntSet{[]uint64{0, 1}}, IntSet{[]uint64{0}}},
		{IntSet{[]uint64{1}}, IntSet{[]uint64{1}}, IntSet{[]uint64{1}}},
		{IntSet{[]uint64{3}}, IntSet{[]uint64{5}}, IntSet{[]uint64{1}}},
	}
...
func TestIntSet_DifferenceWith(t *testing.T) {
	tests := []struct {
		...
		{IntSet{[]uint64{0}}, IntSet{[]uint64{0}}, IntSet{[]uint64{0}}},
		{IntSet{[]uint64{0}}, IntSet{[]uint64{0, 1}}, IntSet{[]uint64{0}}},
		{IntSet{[]uint64{1}}, IntSet{[]uint64{1}}, IntSet{[]uint64{0}}},
		{IntSet{[]uint64{1, 3}}, IntSet{[]uint64{5}}, IntSet{[]uint64{0, 3}}},
	}
...
func TestIntSet_SymmetricDifference(t *testing.T) {
	tests := []struct {
		...
		{IntSet{[]uint64{0}}, IntSet{[]uint64{0}}, IntSet{[]uint64{0}}},
		{IntSet{[]uint64{0}}, IntSet{[]uint64{0, 1}}, IntSet{[]uint64{0, 1}}},
		{IntSet{[]uint64{1}}, IntSet{[]uint64{1}}, IntSet{[]uint64{0}}},
		{IntSet{[]uint64{3}}, IntSet{[]uint64{5}}, IntSet{[]uint64{6}}},
	}
